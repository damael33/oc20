...
joueur.equipe = [Pokemon('salameche', 'Feu', 0, [Attaque('boule feu', 5, 'Feu', 20, 'Combat pokemon/potion.png'), Attaque('boule feu', 5, 'Feu', 20, 'Combat pokemon/potion.png'), Attaque('boule feu', 5, 'Feu', 20, 'Combat pokemon/potion.png'), Attaque('boule feu', 5, 'Feu', 20, 'Combat pokemon/potion.png')], 'Combat pokemon/souris.png', 'Combat pokemon/sprites pokemon/salamèche/salamèche_allié.png', 'Combat pokemon/changement pokemon/changement_pokemon_salameche.png', 0, 0)]
